                	...
                	<div class='art-layout-cell art-sidebar1'>
                    	<div class='art-vmenublock clearfix'>
							...
							<div class='art-vmenublockcontent'>
								<ul class='art-vmenu'>
	                            	<li>
	                                	<a href='/academia-wired/' class='pg-in'>Página inicial</a>
	                                    <ul class='active'>
	                                    	<li>
	                                        	<a href='home/new-page.php'>Subpage 1</a>
	                                        </li>
	                                        <li>
	                                        	<a href='home/new-page-2.php'>Subpage 2</a>
	                                        </li>
	                                        <li>
	                                        	<a href='home/new-page-3.php'>Subpage 3</a>
	                                        </li>
										</ul>
									</li>
									<li>
	                                	<a href='blog' class="bg">Blog</a>
									</li>
									<li>
	                                	<a href='meu-wired' class="me-wi">Meu Wired</a>
									</li>
								</ul>
							</div>
						</div>
						<div class='art-block clearfix'>
							<div class='art-blockheader'>
								<h3 class='t'>Próximos tutoriais</h3>
							</div>
							<div class='art-blockcontent'>
								<?php include 'includes/next-tutors-widget.php';?>
							</div>
						</div>
					</div>
